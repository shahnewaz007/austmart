...
import com.ayon.austmart.activities.DatabaseHelper;
...
public class UserList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name1 = view.findViewById(R.id.name_user_profile);

        String name = currentUser.getDisplayName();
        String email = currentUser.getEmail();
        myDb.insertData(name, email);
        Toast.makeText(getContext(),"Data Pushed",Toast.LENGTH_LONG).show();
